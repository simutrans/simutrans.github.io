...
const add_standardmilestones = (events) => {
  const short_events = [
    ...
    {start: '2004-12', content: "SimuTranslator", source_name: 'SimuTransnlator', source_url: 'https://simutrans-germany.com/translator/doc/team.htm'},
    ...
    {start: '2006-06', content: "Simutrans Tikiwiki", source_name: 'The Simutrans Forum', source_url: 'https://forum.simutrans.com/index.php/topic,15643.0.html'},
